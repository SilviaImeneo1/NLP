...
if __name__ == "__main__":
    ...
    parser.add_argument("--smallCharCNN-folder", default="smallCharCNN", type=str, help="Folder to save the Small CharCNN model")
    parser.add_argument("--largeCharCNN-folder", default="largeCharCNN", type=str, help="Folder to save the Large CharCNN model")
